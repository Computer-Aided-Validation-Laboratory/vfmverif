//==============================================================================
// Gmsh 3D parametric plate with hole mesh (with radial biasing)
...
If(!Exists(bias_factor))
    bias_factor = 1.5; // Factor to bias mesh from fine (near hole) to coarse
EndIf
file_name = Sprintf("platehole3d_bias_mr%g.msh", MR);
